...
def create_phoneme_data(num_words):
    ...
    unique_phonemes = list(phoneme_set)[:30]
    ...
    return phoneme_sequences_ids, word_mapping, word_to_index, phoneme_to_id

# Set the number of words to select
num_words = 200

# Create the phoneme data
phoneme_sequences, word_mapping, word_to_index, phoneme_to_id = create_phoneme_data(num_words)
