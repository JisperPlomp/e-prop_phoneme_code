...
# training parameters
tf.app.flags.DEFINE_integer('n_batch', 7, 'batch size')
tf.app.flags.DEFINE_integer('n_iter', 200, 'total number of iterations')
...
for k_iter in range(FLAGS.n_iter):
    ...
    for i in range(FLAGS.n_batch):
        ...
        if non_zero_sequence in word_mapping:
            ...
            firing_rates_per_word[word].append(results_values['recall_errors'].tolist())
