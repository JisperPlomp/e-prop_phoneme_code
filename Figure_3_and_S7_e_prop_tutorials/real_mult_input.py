...
# Training parameters
tf.app.flags.DEFINE_integer('n_batch', 100, 'Batch size')
...
print("n_in:", n_in)
input_encoding_type = "REALLY multiple neurons"
active_share = 1
...
def get_data_dict(batch_size):
    spk_data, in_nums, target_data = generate_phoneme_data_unique_patterns(batch_size, phoneme_sequences, word_mapping, num_neurons=int(n_in / len(phoneme_to_id)), cue_spacing=2,active_share=active_share)
    return {
