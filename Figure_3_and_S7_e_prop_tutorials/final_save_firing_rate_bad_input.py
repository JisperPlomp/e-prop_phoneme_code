...
for k_iter in range(FLAGS.n_iter):
    ...
    for i in range(FLAGS.n_batch):
        ...
        non_zero_sequence = tuple(seq for seq in sequence if seq != 0)
        print("Sequence:", sequence)  # Debugging
        print("Non-zero Sequence:", non_zero_sequence)  # Debugging
        print("Word Mapping Keys:", word_mapping.keys())  # Debugging
        if non_zero_sequence in word_mapping:
            ...
            print("Non-zero sequence not found in word mapping")  # Debugging
