...
# Plot total firing rate distribution
#plot_firing_rate_distribution(np.array(neuron_activations[0]), np.array(neuron_activations[-1]), "Firing Rate Distribution (First vs Last Iteration)", bins=20, range=(0, 0.2))
